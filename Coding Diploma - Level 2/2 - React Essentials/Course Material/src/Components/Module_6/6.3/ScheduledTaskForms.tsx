...
const ScheduledTaskForms_5_3_1 = () => {
  const [tasks, setTasks] = useState<Task[]>([
    { id: 1, title: "Job 1", jobs: ["Read Emails"], status: "stopped" },
    { id: 2, title: "Job 2", jobs: ["Web Parsing"], status: "running" },
    { id: 3, title: "Job 3", jobs: ["Web Parsing"], status: "running" },
    { id: 4, title: "Job 4", jobs: ["Send Emails"], status: "completed" },
  ]);
