...
const ConditionalTemplates = () => {
  ...
  return (
    <>
      ...
      <ul className="flex overflow-auto items-center">
        {show &&
          bots.map(({ id, name, status }) => (
            <li
              ...
              className={
                status === "Completed"
                  ? " bg-green-600 hover:bg-green-800 border border-gray-400 rounded m-2 min-w-[250px]"
                  : "border border-gray-400 rounded m-2 min-w-[250px]"
              }
            >
              <div className="flex flex-col mx-2">
                ...
                <button
                  className="bg-red-500 hover:bg-red-700 text-white p-1 m-1 rounded mb-4"
